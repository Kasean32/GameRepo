...
INSERT INTO Product (itemID, name, Cond, Platform, Price) 
VALUES
...
INSERT INTO Orders (ordID, List, Cost, Curr_stat)
VALUES
...
INSERT INTO Game (Catergory, Game_Dev, gPublish, Cond, ERSB)

VALUES
('Thriller', 'Two-Take', 'Rockstar', 'N', 'M'),
('Sports', 'EA', '2k Sports', 'U', 'E'),
('Sports', 'Ghost Games', 'Electronic Arts', 'U', 'E'),
('Horror', 'Biohard', 'Capcon', 'N', 'T'),
('Adventure', 'Sega', 'Capcon', 'U', 'E'),
('Shooter', 'Treyarch', 'Activision', 'U', 'E');
