...
CREATE TABLE IF NOT EXISTS Resume (	
	...
	FOREIGN KEY(empID) REFERENCES Employee(eID) --I suggest comment this part out along with foreign key
);
...
CREATE TABLE IF NOT EXISTS Orders ( --changed this tble to match our insert tables
	ordID VARCHAR(10) NOT NULL,
	List VARCHAR(100),
	cost INTEGER NOT NULL DEFAULT 0,
	cur_stage VARCHAR(20) DEFAULT 'In Store' NOT NULL,
	CONSTRAINT pk_stageID PRIMARY KEY (ordID)
);
